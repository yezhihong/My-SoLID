...
void generate_acc(TString particle,int hadron_flag){
	...
	if(particle=="pion"){
		...
		if(hadron_flag==2){
			...
			o->Add("./sidis_3he_km_11_0_2_0.root");   // save Q2<10, pt>1
		}
	}
	...
	//TFile *file_negative=new TFile("acceptance_solid_CLEO_SIDIS_3he_negative_output2.root");
	...
	can_forward->cd(6);
	hf_z_pt->Draw("COLZ");
	can_forward->Print(Form("NewACC_OldXS_%s_%s_Forward.pdf", particle.Data(), charge.Data()));
	can_forward->Print(Form("NewACC_OldXS_%s_%s_Forward.png", particle.Data(), charge.Data()));
	...
	can_large->cd(6);
	hl_z_pt->Draw("COLZ");
	can_large->Print(Form("NewACC_OldXS_%s_%s_Large.pdf", particle.Data(), charge.Data()));
	can_large->Print(Form("NewACC_OldXS_%s_%s_Large.png", particle.Data(), charge.Data()));
	...
	can_total->Print(Form("NewACC_OldXS_%s_%s_Total.pdf", particle.Data(), charge.Data()));
	can_total->Print(Form("NewACC_OldXS_%s_%s_Total.png", particle.Data(), charge.Data()));
	...
	c1->cd(4);
	hl_theta->Draw();
	c1->Print(Form("NewACC_OldXS_%s_%s_ThetaP.pdf", particle.Data(), charge.Data()));
	c1->Print(Form("NewACC_OldXS_%s_%s_ThetaP.png", particle.Data(), charge.Data()));
	/*}}}*/
