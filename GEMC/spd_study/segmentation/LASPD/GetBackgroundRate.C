...
void GetBackgroundRate(){
	...
	c1->Print("Rate_Electron_Background.png");
	c2->Print("Rate_Photon_Background.png");
	c3->Print("Rate_Both_Background.png");
	c1->Print("Rate_Electron_Background.pdf");
	c2->Print("Rate_Photon_Background.pdf");
	c3->Print("Rate_Both_Background.pdf");
	c4->Print("Rate_Both_Background_EDep.png");
	c4->Print("Rate_Both_Background_EDep.pdf");

   TFile *new_file = new TFile("histo_background.root","recreate");
   new_file->cd();
