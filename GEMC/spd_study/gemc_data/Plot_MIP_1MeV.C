{
	...
	TFile *output = new TFile("SPD_EDep_1MeV.root","recreate");

	TCanvas *c1 = new TCanvas("c1","c1",1200,800);
	c1->Divide(1,2);
	TFile *fE1 = new TFile("electron/5mm/SIDIS_SPD_E1MeV_out.root");
	TFile *fE2 = new TFile("electron/1cm/SIDIS_SPD_E1MeV_out.root");
	TFile *fE3 = new TFile("electron/2cm/SIDIS_SPD_E1MeV_out.root");
//	TFile *fE4 = new TFile("electron/5cm/SIDIS_SPD_E1MeV_out.root");

 	TFile *fG1 = new TFile("photon/5mm/SIDIS_SPD_G1MeV_out.root");
	TFile *fG2 = new TFile("photon/1cm/SIDIS_SPD_G1MeV_out.root");
	TFile *fG3 = new TFile("photon/2cm/SIDIS_SPD_G1MeV_out.root");
//	TFile *fG4 = new TFile("photon/5cm/SIDIS_SPD_G1MeV_out.root");

 
	c1->cd(1); fE1->cd();
	TH1F *hE1 = new TH1F("hE1","5mm LASPD (electron)",100,1e-9, 2.0);
	hE1->SetLineColor(2);
	...
	c1->cd(1); fE2->cd();
	TH1F *hE2 = new TH1F("hE2","1cm LASPD (electron)",100,1e-9, 2.0);
	hE2->SetLineColor(4);
	...
	c1->cd(1); fE3->cd();
	TH1F *hE3 = new TH1F("hE3","2cm LASPD (electron)",100,1e-9, 2.0);
	hE3->SetLineColor(6);
	...
	c1->cd(2); fG1->cd();
	TH1F *hG1 = new TH1F("hG1","5mm LASPD (photon)",100,1e-9, 2.0);
	hG1->SetLineColor(2);
	hG1->SetLineWidth(2.);
	hG1->SetLineStyle(9);
	T->Draw("Edep>>hG1","");
	...
	c1->cd(2); fG2->cd();
	TH1F *hG2 = new TH1F("hG2","1cm LASPD (photon)",100,1e-9, 2.0);
	hG2->SetLineColor(4);
	...
	c1->cd(2); fG3->cd();
	TH1F *hG3 = new TH1F("hG3","2cm LASPD (photon)",100,1e-9, 2.0);
	hG3->SetLineColor(6);
...
/*
	c1->cd(1); fE4->cd();
	TH1F *hE4 = new TH1F("hE4","5cm LASPD (electron)",400,1e-9, 2.0);
	hE4->SetLineColor(6);
	hE4->SetLineWidth(1.5);
	hE4->SetLineStyle(1);

	c1->cd(2); fG4->cd();
	TH1F *hG4 = new TH1F("hG4","5cm LASPD (photon)",400,1e-9, 2.0);
	hG4->SetLineColor(6);
...
*/
	...
	TH2F *hEDep5mm = new TH2F("hEDep5mm","5mm SPD with Electron (0-1 MeV)",100,1e-9, 1.0,100, 1e-2, 1.0);
    T->Draw("Edep:Ee>>hEDep5mm","","colz");
	c2->cd(2); fE2->cd();gPad->SetLogy(1);
	TH2F *hEDep1cm = new TH2F("hEDep1cm","1cm SPD with Electron (0-1 MeV)",100,1e-9, 1.0,100, 1e-2, 1.0);
    T->Draw("Edep:Ee>>hEDep1cm","","colz");
	c2->cd(3); fE3->cd();gPad->SetLogy(1);
	TH2F *hEDep2cm = new TH2F("hEDep2cm","2cm SPD with Electron (0-1 MeV)",100,1e-9, 1.0,100, 1e-2, 1.0);
    T->Draw("Edep:Ee>>hEDep2cm","","colz");
	//c2->cd(4); fE4->cd();gPad->SetLogy(1);
	//TH2F *hEDep5cm = new TH2F("hEDep5cm","5cm SPD with Electron (0-1 MeV)",100,1e-9, 1.0,100, 1e-3, 1.0);
    //T->Draw("Edep:Ee>>hEDep5cm","","colz");

	c2->cd(4); fG1->cd();gPad->SetLogy(1);
	TH2F *hGDep5mm = new TH2F("hGDep5mm","5mm SPD with Photon (0-1 MeV)",100,1e-9, 1.0,100, 1e-2, 1.0);
    T->Draw("Edep:Eg>>hGDep5mm","","colz");
	c2->cd(5); fG2->cd();gPad->SetLogy(1);
	TH2F *hGDep1cm = new TH2F("hGDep1cm","1cm SPD with Photon (0-1 MeV)",100,1e-9, 1.0,100, 1e-2, 1.0);
    T->Draw("Edep:Eg>>hGDep1cm","","colz");
	c2->cd(6); fG3->cd();gPad->SetLogy(1);
	TH2F *hGDep2cm = new TH2F("hGDep2cm","2cm SPD with Photon (0-1 MeV)",100,1e-9, 1.0,100, 1e-2, 1.0);
    T->Draw("Edep:Eg>>hGDep2cm","","colz");
//	c2->cd(8); fG4->cd();gPad->SetLogy(1);
//	TH2F *hGDep5cm = new TH2F("hGDep5cm","5cm SPD with Photon (0-1 MeV)",100,1e-9, 1.0,100, 1e-2, 1.0);
  //  T->Draw("Edep:Eg>>hGDep5cm","","colz");
...
//	TH1F* hGDep5cm_px = (TH1F*) hGDep5cm->ProfileX("hGDep5cm_px"); hGDep2cm_px->Draw();
   ...
   c2->Print("SPD_EDep_2D_1MeV.png");
   c3->Print("SPD_EDep_1D_1MeV.png");
