...
Int_t main()
{
	...
	/*Read in each event{{{*/
	ofstream laoutfile("SoLID_SIDIS_He3_LA_pip_new.dat");
	ofstream faoutfile("SoLID_SIDIS_He3_FA_pip_new.dat");
...
//					gen_mom[Is_Electron]*MeV2GeV,gen_theta[Is_Electron],gen_phi[Is_Electron],
			...
			for(Int_t ip=0;ip<4;ip++){//four GEMCs in front of LAEC
				laoutfile <<Form("%2d %5d %10.2e %10.2e %10.2e %10.2e %10.2e %10.2e %10.2e %10.2e %10.2e %10.2e %10.2e", 
...
//					gen_mom[Is_Electron]*MeV2GeV, gen_theta[Is_Electron], gen_phi[Is_Electron],
			...
			for(Int_t ip=0;ip<6;ip++){//four GEMCs in front of LAEC
				faoutfile <<Form("%2d %5d %10.2e %10.2e %10.2e %10.2e %10.2e %10.2e %10.2e %10.2e %10.2e %10.2e %10.2e", 
						ip+1, GEM_PID_Pick[ip],
//						GEM_Mom[ip],GEM_Theta[ip],GEM_Phi[ip],
						GEM_Px[ip], GEM_Py[ip], GEM_Pz[ip],
						GEM_Vx[ip], GEM_Vy[ip], GEM_Vz[ip],
